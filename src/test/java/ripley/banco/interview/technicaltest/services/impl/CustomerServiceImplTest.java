...
public class CustomerServiceImplTest {
    ...
    public void findCustomer_shouldThrowControlCharacterContainForbiddenCharactersException(String rut) {
        ...
        ForbiddenControlCharacterException exception = assertThrows(ForbiddenControlCharacterException.class, () -> {
            customerServiceImpl.findCustomer(rut);
        });
    ...
    public void findCustomer_shouldThrowNotValidControlDigitException(String rut) {
        ...
        NotValidControlDigitException exception = assertThrows(NotValidControlDigitException.class, () -> {
            customerServiceImpl.findCustomer(rut);
        });
